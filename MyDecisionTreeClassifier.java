...
public class MyDecisionTreeClassifier {

	ArrayList<String> headers = new ArrayList<String>();

	public MyDecisionTreeClassifier(ArrayList<String> headers) 
	{
	...
	{
		ArrayList<ArrayList<ArrayList<String>>> trueFalseList = new ArrayList<ArrayList<ArrayList<String>>>();
		ArrayList<ArrayList<String>> trueList = new ArrayList<ArrayList<String>>();
